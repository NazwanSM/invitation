...
const RSVPSection = () => {
  ...
  if (response === 'accepted') {
    return (
      <>
        ...
        <section className="bg-gradient-to-b from-gray-800 to-gray-900 p-10 md:p-16 text-center space-y-8 rounded-lg shadow-2xl">
          <div className="animate-float">
            <span className="text-6xl">🎉</span>
          </div>
          
          <div className="space-y-4">
            <h3 className="text-3xl md:text-4xl font-serif text-white">Yeay! Sampai Jumpa Besok!</h3>
            <p className="text-gray-300 font-light text-lg">Can't wait to spend the day with you ✨</p>
          </div>

          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 space-y-3">
            <p className="text-white font-medium">📍 Reminder</p>
            <p className="text-gray-300 text-sm">Jangan tidur malem malem yahh</p>
            <p className="text-gray-300 text-sm">Aku jemput kamu dari pagi 🙏 (semoga)</p>
          </div>
  ...
  if (response === 'declined') {
    return (
      <section className="bg-red-50 p-10 md:p-16 text-center space-y-6 rounded-lg border-2 border-red-200">
        <span className="text-5xl">😤</span>
        <h3 className="text-2xl font-serif text-gray-800">Harus bisa ah gamau tau!</h3>
        <p className="text-gray-600 font-light">Pokoknya kamu harus acc, titik. 🙅‍♂️</p>
        <button 
          onClick={() => setResponse(null)}
          className="mt-4 px-6 py-3 bg-gray-800 text-white text-sm tracking-widest uppercase hover:bg-gray-700 transition-all duration-300 rounded-lg"
        >
          Oke oke, aku ACC deh 😅
        </button>
      </section>
  ...
  return (
    <section className="bg-white p-8 md:p-12 shadow-sm border border-gray-100 text-center space-y-8 rounded-lg">
      <div className="space-y-4">
        <h3 className="text-2xl font-serif text-gray-800">So, What Do You Say?</h3>
        <p className="text-gray-600 font-light">Gimana? ACC ga nih?</p>
      </div>
      
      <div className="flex flex-col sm:flex-row justify-center gap-4 pt-4">
        <button 
          onClick={handleAccept}
          className="group px-8 py-4 bg-gray-800 text-white text-sm tracking-widest uppercase hover:bg-gray-700 transition-all duration-300 rounded-lg shadow-lg hover:shadow-xl hover:scale-105 flex items-center justify-center gap-3"
        >
        ...
        <button 
          ...
          className="px-8 py-4 bg-transparent text-gray-500 text-sm tracking-widest uppercase hover:text-gray-700 hover:bg-gray-100 transition-all duration-300 rounded-lg border border-gray-200"
        >
          <span>Hmm, Belum...</span>
        </button>
      </div>
    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-6 text-center bg-[#FAFAF9]">
      <div className="max-w-md w-full space-y-8 fade-in">
        ...
        <div className="pt-8">
          <button 
            onClick={onOpen}
            className="px-8 py-3 bg-gray-800 text-white text-sm tracking-widest uppercase hover:bg-gray-700 transition-all duration-300 rounded-sm"
          >
...
const MainContent = () => {
  return (
    <div className="min-h-screen bg-[#FAFAF9] py-16 px-6 md:px-20 fade-in">
      <div className="max-w-3xl mx-auto space-y-16">
        
        {/* Header */}
        <header className="text-center space-y-4">
          <p className="text-xs tracking-[0.4em] uppercase text-gray-400">The Itinerary</p>
          <h2 className="text-4xl md:text-5xl font-serif text-gray-800">Quality Time.</h2>
        ...
        <section className="py-8">
            <p className="text-center text-xs tracking-[0.4em] uppercase text-gray-400 mb-8">Sneak Peek</p>
            <div className="flex flex-wrap justify-center gap-8 md:gap-12">
                <div className="bg-white p-3 shadow-lg -rotate-3 hover:rotate-0 transition-transform duration-500 w-48 md:w-56 cursor-pointer">
                    <div className="aspect-[4/5] bg-gray-200 overflow-hidden mb-3">
                    ...
                    <p className="text-center font-serif text-sm italic text-gray-600">Sarapan di tempat viral</p>
                </div>

                <div className="bg-white p-3 shadow-lg rotate-2 hover:rotate-0 transition-transform duration-500 w-48 md:w-56 cursor-pointer mt-8 md:mt-0">
                    <div className="aspect-[4/5] bg-gray-200 overflow-hidden mb-3">
                    ...
                    <p className="text-center font-serif text-sm italic text-gray-600">Bermain</p>
                </div>
                
                 <div className="bg-white p-3 shadow-lg -rotate-1 hover:rotate-0 transition-transform duration-500 w-48 md:w-56 cursor-pointer">
                    <div className="aspect-[4/5] bg-gray-200 overflow-hidden mb-3">
                    ...
                    <p className="text-center font-serif text-sm italic text-gray-600">Perwalian</p>
                </div>

                <div className="bg-white p-3 shadow-lg rotate-3 hover:rotate-0 transition-transform duration-500 w-48 md:w-56 cursor-pointer mt-8 md:mt-0">
                    <div className="aspect-[4/5] bg-gray-200 overflow-hidden mb-3">
                    ...
                    <p className="text-center font-serif text-sm italic text-gray-600">Foto fotow</p>
                </div>

                <div className="bg-white p-3 shadow-lg -rotate-2 hover:rotate-0 transition-transform duration-500 w-48 md:w-56 cursor-pointer">
                    <div className="aspect-[4/5] bg-gray-200 overflow-hidden mb-3">
                    ...
                    <p className="text-center font-serif text-sm italic text-gray-600">Mam</p>
                </div>
            </div>
        </section>
        ...
        <section className="bg-white p-8 md:p-12 shadow-sm border border-gray-100 text-center space-y-6">
          <h3 className="text-2xl font-serif text-gray-800">Dresscode</h3>
          <p className="text-gray-600 font-light">Casual Chic. Pake baju yang nyaman dipake ngapain aja dan bagus buat foto.</p>
          <div className="flex justify-center gap-4 pt-2">
            <div className="flex flex-col items-center gap-2">
              <div className="w-10 h-10 rounded-full bg-[#E5D3B3] shadow-inner"></div>
              <span className="text-[10px] uppercase tracking-wider text-gray-400">Beige</span>
            </div>
            <div className="flex flex-col items-center gap-2">
              <div className="w-10 h-10 rounded-full bg-[#FFFFFF] border border-gray-200 shadow-inner"></div>
              <span className="text-[10px] uppercase tracking-wider text-gray-400">White</span>
            </div>
            <div className="flex flex-col items-center gap-2">
              <div className="w-10 h-10 rounded-full bg-[#8E7F7F] shadow-inner"></div>
              <span className="text-[10px] uppercase tracking-wider text-gray-400">Earth</span>
            </div>
          </div>
        </section>
        ...
        <footer className="text-center pt-12 border-t border-gray-200 space-y-8">
          <p className="text-gray-600 font-serif italic text-lg">"See you there."</p>
        </footer>
      </div>
    </div>
  );
